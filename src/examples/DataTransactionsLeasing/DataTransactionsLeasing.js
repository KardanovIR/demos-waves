...
import {
	...
	FormControlLabel,
	Table,
	TableHead, TableRow, TableCell, TableBody, AppBar, Tabs, Tab
} from "material-ui";
...
class WebAuthAPI extends React.Component {
	...
	openAuthWindow = () => {
		window.open(this.getAuthLink(), 'AUTH_TAB', 'status=1,toolbar=0,menubar=0&height=500,width=700,top=0,left=0', false);
	};
		...
		return (
			<Grid>
				<Grid container justify="center" className={classes.root} spacing={16}>
					<Grid item xs={8} sm={8}>
						<Typography>
							This demo project shows how to use Data Transactions for custom tokens leasing.
						</Typography>
						<Typography>
							The main idea is to store information about leased tokens and amounts in Data Transactions with proper key.
							Data is stored under `custom_asset_leased` key as JSON array like:
