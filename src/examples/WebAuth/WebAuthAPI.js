				...
				<Grid container justify="center" className={classes.root} spacing={16}>
					<Grid item xs={8} sm={8}>
						<Typography>If you want to authorize a user in your service by means of his Waves account, here's the
							...
							to be
							changed later) with certain query parameters including some arbitrary data for him to sign.</Typography>
						
						<Typography>That might be needed in cases when you need to either work with user personal data and be sure
							that
