...
import {
    ...
    Typography,
    CardContent,
    Grid, DialogContent, DialogContentText,
    TextField,
          ...
          <Grid>
              <Grid container justify="center" className={classes.root} spacing={16}>
                  <Grid item xs={8} sm={8}>
                      <Typography>
                        ...
                        href="https://medium.com/wavesgo-educationfund/wavesgo-education-fund-d9e6149e0f70"
                        target="_blank">WavesGo
                          Education Fund.</a>
                      </Typography>
                      <Typography>
              ...
              <Grid container alignItems="center" direction="row" justify="center" spacing={16}>
                  ...
                  <Grid item xs={6} sm={6} className={classes.paper}>
                      ...
                      <Card className={classes.card} elevation={4}>
                          <CardContent>
                              <Button size="small" variant="raised" color="primary" onClick={this.openPayWindow}>Pay
                                  with
                                  <span
              ...
              >
                  ...
                  <DialogContent>
                      <DialogContentText>
                          Congratulations and thank you! We appreciate your contribution to the development of our
                          community
                      </DialogContentText>
                  </DialogContent>
                  <DialogActions>
