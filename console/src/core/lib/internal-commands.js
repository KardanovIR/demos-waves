...
const welcome = () => ({
  value: `Use <strong>:help</strong> to show commands
version: ${version}.
This console users Waves JS library - https://github.com/wavesplatform/waves-api.
Waves is available in global scope.`,
  html: true,
});
...
const libs = {
  ...
  // waves: 'https://cdn.jsdelivr.net/npm/waves-api@0.24.2/dist/waves-api.min.js',
};
